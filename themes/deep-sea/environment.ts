...
export const environment: AsciiArt[] = [
  {
  ...
  ~~~~~~~~~~~~~~~~~~~~`,
    ...
    whyEffective:
      'The \\|/ pattern creates branching coral reaching upward. The {*} and {@} represent different coral polyp types. The repeating pattern suggests a dense reef ecosystem. The ~~~ seabed provides grounding. Layered complexity mimics real reef diversity.',
    keyCharacters: ['\\', '|', '/', '*', '@', '~', '{', '}'],
  ...
  <°)><  ><((°>  <°°)><`,
    ...
    whyEffective:
      'The classic ><(°> fish pattern is universally recognized. Varying sizes (single vs double parentheses) create depth. The scattered, non-grid placement mimics natural schooling behavior. Mixing left <°)>< and right ><(°> facing fish shows movement.',
    keyCharacters: ['<', '>', '(', ')', '°'],
 ...
 ><(°  )>    ___
  ...
  ~~~~~~~~~~~~~~~~~~~~~~~~~~`,
    ...
    whyEffective:
      'Combines multiple elements: fish ><>, octopus {@ @}, coral \\|/{*}, and water ~~~. The * characters create bioluminescent atmosphere. Layered composition gives depth. Shows how individual elements combine into a complete ecosystem scene.',
    keyCharacters: ['~', '*', '><>', '@', '^', '/', '\\', '{', '}'],
