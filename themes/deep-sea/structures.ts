...
export const structures: AsciiArt[] = [
  {
   ...
   ~~~~~~~~~~`,
    ...
    whyEffective:
      'The $ symbols are universally recognized as money/treasure. The box structure [| |] is clearly a container. The word \'coins\' adds clarity. The ~~~ seabed grounds it underwater. Simple and immediately readable.',
    keyCharacters: ['$', '[', ']', '|', '=', '~'],
...
`,
  ...
  |=|===|=|
   \\|_|_|/
    ...
    whyEffective:
      'The [¤¤¤] helmet top with decorative characters suggests the brass construction. The {o o} viewport shows a face peering out. The |=|===|=| represents the bulky suit with air hoses. Weighted boots O O at bottom complete the iconic silhouette.',
    keyCharacters: ['¤', 'o', '=', '|', 'O', '{', '}'],
  ...
  },
  {
   ...
   |---=============---|>
    ...
    whyEffective:
      'The elongated shape uses extended underscores for the hull. Portholes [°] in a row suggest the interior and crew. The propeller |> at rear shows direction. The @@@ at bottom could be ballast tanks. Clean lines convey engineered precision.',
    keyCharacters: ['[', ']', '°', '=', '-', '>', '@'],
