...
export const creatures = [
  ...
  {°>====<########}
   \`--.__.-'`,
        ...
        whyEffective: 'The asterisk (*) isolated at top creates the glowing lure through irradiation. Dense # characters for bulk, eye ° and mouth :> convey predatory menace. Dangling stem connects lure to head.',
        keyCharacters: ['*', '°', '#', '>', ':'],
...
`,
  ...
  {°>====<###}
   ...
   ~~~~~~~~~~~~~~~~~~^~^~^~~`,
        ...
        whyEffective: 'Perfect bilateral symmetry for recognition. Large @ eyes convey power. Dense ¤ mantle. Alternating tentacle patterns splay outward with chaotic motion suggestion.',
        keyCharacters: ['@', '¤', '/', '\\', '~', '^'],
    ...
    (  *  *  )
     \`-._..-'
      ...
      ': :'`,
        ...
        whyEffective: 'Wavy dome suggests undulating bell. Asterisks represent bioluminescent organs. Straight tentacles contrast with curved body. Delicate trailing filaments.',
        keyCharacters: ['~', '*', '|', ':', "'"],
  ...
  {~^/\\/\\/\\/\\/\\/\\^~}
   ~~/~~/~~/~~/~~\\~~`,
        ...
        whyEffective: 'Expressive {@ @} eyes create face. Multiple /\\/ layers create sense of eight tentacles. ~ characters throughout suggest fluid motion. Dense character mixing conveys complex texture.',
        keyCharacters: ['@', '^', '/', '\\', '~', '{', '}'],
 ...
 <=|  /#####\\  |=>
    \`-._____.-'
        ...
        whyEffective: 'Nested patterns show shell texture: outer smooth curve, inner ##### for scutes. Flippers <= => point outward showing motion. Tail completes silhouette. Compact but recognizable.',
        keyCharacters: ['=', '#', '<', '>', '/', '\\'],
 ...
 <°_____________)=====>
    \\         /
     \`~~~\\/~~'`,
        ...
        whyEffective: 'Iconic dorsal fin |\\ immediately recognizable. Pointed snout < conveys speed and aggression. Body tapers to =====> suggesting powerful thrust. Trailing ~~~\\/ shows wake.',
        keyCharacters: ['<', '|', '\\', '=', '>', '~', '°'],
 ...
 <°_____________)=====>
   ...
   \\__/=,
    ...
    ~~~\`\`\``,
        ...
        whyEffective: 'Eye stalks use size graduation to show depth. @@ creates beady crab eyes. Spiral S hints at snail shell home. Dense lower portion suggests shell weight. ~~~ grounds on sand.',
        keyCharacters: ['o', 'O', '@', 'S', '~', '`'],
   ...
   *  .  *  .  *`,
        ...
        whyEffective: 'Scattered * and . create bioluminescent particle field - irradiation effect makes them appear to glow. Fish <°)))>< use classic ASCII pattern. {*} center fish has glowing organ. Symmetry creates balance.',
        keyCharacters: ['*', '.', '<', '>', '°', '{', '}'],
   ...
   *  .  *  .  *`,
   ...
   {°|||||>--------->
    \\\\\\\\\\\\\\____________)
        ...
        whyEffective: 'Like anglerfish, isolated * creates glowing lure through irradiation. ||||| represents needle-like teeth. Elongated body -----> shows the fish\'s length. Trailing ~~~~~ suggests deep water. \\\\\\\\ adds lower jaw texture.',
        keyCharacters: ['*', '|', '>', '-', '~', '°'],
